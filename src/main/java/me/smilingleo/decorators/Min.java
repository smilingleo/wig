...
/**
 * Min takes in a list, return a value.
 */
public final class Min implements Decorator, WithFieldArg, ReturningScalar {
    ...
    public static Min parse(String label) {
    ...
    public Object evaluate(Object input) {
        ...
        Object min = ((Map<String, Object>) headObj).get(fieldName);
        for (Map<String, Object> item : list) {
            Object value = item.get(fieldName);
            int cmp = Objects.compare(min, value, (o1, o2) -> {
                if (o1 == null && o2 == null) {
                    return 0;
                }
                if (o1 == null && o2 != null) {
